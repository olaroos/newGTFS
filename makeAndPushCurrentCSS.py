...
theFile.close()
theFile = open('266_1_BLT/266_1_BLT_stationNames', 'r')
...
raw     = theFile.readlines()
theFile.close()
theFile = open('266_2_BLT/266_2_BLT_stationNames', 'r')
rawName    = theFile.readlines()
theFile.close()
...
raw     = theFile.readlines()
theFile.close()
theFile = open('266_3_BLT/266_3_BLT_stationNames', 'r')
rawName    = theFile.readlines()
theFile.close()
...
raw     = theFile.readlines()
theFile.close()
theFile = open('266_4_BLT/266_4_BLT_stationNames', 'r')
rawName    = theFile.readlines()
theFile.close()
...
raw     = theFile.readlines()
theFile.close()
theFile = open('266_5_BLT/266_5_BLT_stationNames', 'r')
rawName    = theFile.readlines()
theFile.close()
...
raw     = theFile.readlines()
theFile.close()
theFile = open('266_6_BLT/266_6_BLT_stationNames', 'r')
rawName    = theFile.readlines()
theFile.close()
